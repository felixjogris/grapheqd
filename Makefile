...
grapheqd:	grapheqd.c rootpage.h favicon.h $(KISSFFT)/kiss_fft.h $(KISSFFT)/kiss_fft.c
	$(CC) -W -Wall -O3 -pipe -I$(KISSFFT) -Dkiss_fft_scalar=float -o $@ grapheqd.c $(KISSFFT)/kiss_fft.c -lm -lpthread -lasound -lcrypto
...
realclean: ;	-rm -v grapheqd rootpage.h favicon.h
